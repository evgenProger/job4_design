...
class CyclicIteratorTest {
    ...
    void whenEmptyThenHasNextIsFalse() {
        CyclicIterator iterator = new CyclicIterator(List.of());
    ...
    void whenNotEmptyThenHasNextIsTrue() {
        CyclicIterator iterator = new CyclicIterator(List.of(1));
    ...
    void whenNotEmptyThenNext() {
        CyclicIterator iterator = new CyclicIterator(List.of(1, 2, 3));
        assertThat(iterator.next()).isEqualTo(1);
        assertThat(iterator.hasNext()).isTrue();
